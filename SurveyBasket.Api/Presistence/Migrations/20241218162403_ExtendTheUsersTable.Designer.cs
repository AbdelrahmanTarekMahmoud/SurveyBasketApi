...
namespace SurveyBasket.Api.Presistence.Migrations
{
    ...
    [Migration("20241218162403_ExtendTheUsersTable")]
    partial class ExtendTheUsersTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SurveyBasket.Api.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEB6bXrSww+MSMmnCE1d22SqK9ui6qUycF2JJr9aw1uV8S9x4qSMrvytfDyVyyVdgPA==",
            ...
            modelBuilder.Entity("SurveyBasket.Api.Entities.Vote", b =>
                {
                    ...
                    b.Property<DateTime>("SumbittedOn")
                        .HasColumnType("datetime2");
